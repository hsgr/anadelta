...
#define STRING_CONFIG_H_AUTHOR "(maxchaos, initial config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "anadelta"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "d249c20d-2ec9-4fd0-b440-9ca8f4698efe"
...
// If your bed has low resistance e.g. .6 ohm and
// throws the fuse you can duty cycle it to reduce the average current.
// The value should be an integer and the heat bed will be turned on
// for 1 interval of HEATER_BED_DUTY_CYCLE_DIVIDER intervals.
//#define HEATER_BED_DUTY_CYCLE_DIVIDER 4

// If you want the M105 heater power reported in watts,
// define the BED_WATTS, and (shared for all extruders) EXTRUDER_WATTS
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // TODO: Need to find appropriate gains.
...
//i.e. if the temperature is under the limit
//can be software-disabled for whatever purposes by
#define PREVENT_DANGEROUS_EXTRUDE
//if PREVENT_DANGEROUS_EXTRUDE is on,
//you can still disable (uncomment) very long bits of extrusion separately.
...
#define DELTA
  ...
  //#define DELTA_SEGMENTS_PER_SECOND 200 // default value
  #define DELTA_SEGMENTS_PER_SECOND 160 /* Value of kossel pro (due to size???) */

  // NOTE NB all values for DELTA_* values MUST be floating point,
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 292.8 /* Euclidean distance to each rod. */
  //#define DELTA_SMOOTH_ROD_OFFSET 290.8 /* Center of both rods. */
