...
#define STRING_CONFIG_H_AUTHOR "(zisi, updates for marlin-1.1.0-rc7)" // Who made the changes.
...
#define SOURCE_CODE_URL "https://github.com/hsgr/anadelta"
...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 290.9 // mm
...
#define MANUAL_Z_HOME_POS 552 // Distance between the nozzle to printbed after homing
...
#define HOB_EFFECTIVE_DIAMETER 7

// delta speeds must be the same on xyz
#define XYZ_STEPS (XYZ_FULL_STEPS_PER_ROTATION * XYZ_MICROSTEPS / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH))
#define E_STEPS   (XYZ_FULL_STEPS_PER_ROTATION * XYZ_MICROSTEPS / (double(HOB_EFFECTIVE_DIAMETER) * M_PI))
